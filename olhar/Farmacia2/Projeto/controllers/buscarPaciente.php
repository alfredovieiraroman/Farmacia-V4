    ...
    <div class="container">
        ...
        class buscarPaciente extends Banco
        {
            ...
            public function mostrarPaciente()
            {
                ...
                $sql = "SELECT paciente.id_paciente, paciente.tipoPaciente, paciente.dosagem, virus.nomePopular, medicamentos.nomeVenda
                FROM paciente JOIN virus 
                ON virus.id_virus = paciente.fk_id_virus JOIN medicamentos ON medicamentos.id_medicamentos = paciente.fk_id_medicamento";
        ...
        <hr>
        <div id="buscar">
            <form action="../controllers/buscarPaciente.php" method="POST">
                <div class="form-group">
                    <label for="tipoPaciente">Buscar Pacientes</label>
