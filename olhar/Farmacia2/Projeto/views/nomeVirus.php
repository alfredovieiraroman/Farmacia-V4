...
<body>
    <div class="container">
        <div id="buscar">
            <a href="../views/buscarVirus.php"> <button type="button" id="btn" class="btn btn-primary">Menu</button> </a>
        </div>
        ...
        class buscarVirus extends Banco
        {
            ...
            public function mostrarVirus()
            {
                ...
                $nomeVirus = $_POST['nomeVirus'];

                $sql = "SELECT * FROM virus WHERE nomePopular = '{$nomeVirus}' ";
